      ...
      if (type === 'ethersale') {
        ...
        if (ethereumNode.isEth) {
          ...
          if (process.platform === 'darwin')
            keystorePath += '/Library/Feathereum/keystore';
          ...
          if (
            ...
            keystorePath += '/.feathereum/keystore';

          if (process.platform === 'win32')
            keystorePath = `${Settings.appDataPath}\\Feathereum\\keystore`;
        }
...
ipc.on('mistAPI_requestAccount', e => {
  if (global.mode === 'wallet') {
    ...
    if (e.sender.history[0] === 'https://wallet.feathereum.org/') {
      createAccountPopup(e);
    } else {
